            ...
            <Layout>
              ...
              <Layout style={{ padding: '0 24px 24px' }}>
                {/* <Breadcrumb style={{ margin: '16px 0' }}>
                  <Breadcrumb.Item href="/Job">帖子浏览数据</Breadcrumb.Item>
                  <Breadcrumb.Item>求职招聘</Breadcrumb.Item>
                </Breadcrumb> */}
                {/* <Content
                  style={{
                    background: '#fff',
                ...
                >
                  <TopNav handleClick={this.handleClick.bind(this)}/>
                  <div className="choose-container">
                  地区选择：<Cascader options={ChooseCity.options} onChange={ChooseCity.onChange} changeOnSelect />
                  </div>
                </Content> */}
                {/* 内容渲染 */}
                {this.handlerRender()}
